...
export interface InsecureEtherVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "deposit"
      | "getEtherBalance"
...
export interface InsecureEtherVault extends BaseContract {
  connect(runner?: ContractRunner | null): InsecureEtherVault;
  waitForDeployment(): Promise<this>;

  interface: InsecureEtherVaultInterface;
